...
class Configuration:
    ...
    def processKeyDownEvent(self):
        ...
        if self.event.dict['unicode'] == 'Z' or (
                self.event.mod & pygame.KMOD_SHIFT
    ...
    def display(self):
        ...
        while True:
            ...
            if self.event.type == pygame.QUIT or (
                    self.event.type == pygame.WINDOWEVENT
                    and pygame.event.wait(100).type == pygame.QUIT):
                pygame.quit()
                break
