...
def Q4a():
    ...
    wall1 = Wall({'position': [0, 0, 0], 'width':5, 'height':3 , 'edges': True , 'orientation':0})
    wall2 = Wall({'position': [0, 0, 0], 'width':4, 'height':3 , 'edges': True , 'orientation':90})
    wall3 = Wall({'position': [0, 3.8 , 0], 'width':5, 'height':3, 'edges': True , 'orientation':0})
    wall4 = Wall({'position': [-4, 5,0], 'width':4, 'height':3, 'edges': True , 'orientation':-90})  
